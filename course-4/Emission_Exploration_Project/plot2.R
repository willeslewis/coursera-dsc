...
png("plot2.png")
PM25tots<-tapply(NEI$Emissions[NEI$fips=="24510"],NEI$year[NEI$fips=="24510"],sum,na.rm=TRUE)
plot(as.integer(names(PM25tots)),PM25tots,type="l",main="Total PM2.5 Emissions in Baltimore vs Year",xlab="Year",ylab="Total emissions in Tons")
